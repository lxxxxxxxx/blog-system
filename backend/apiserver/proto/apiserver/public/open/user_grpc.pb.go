...
func (c *userClient) CreateUser(ctx context.Context, in *CreateUserReq, opts ...grpc.CallOption) (*CreateUserRes, error) {
	...
	err := c.cc.Invoke(ctx, "/apiserver.public.open.User/CreateUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _User_CreateUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/apiserver.public.open.User/CreateUser",
	}
...
var User_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "apiserver.public.open.User",
	...
	Metadata: "apiserver/public/open/user.proto",
}
